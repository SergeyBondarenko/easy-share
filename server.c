...
int parseARGS(char **args, char *line){
	...
	// Fill up "args" array with parts of the "line" string, without ":"
...
int client(void *ptr){
	int  connectSOCKET;
	connectSOCKET = (int ) ptr;			// Client socket
...
int main(int argc, char* argv[])
{
	...
	while(1){
		...
		if(socketINDEX=512) { 							// If there are 513 clients, set new index to 0
			socketINDEX = 0;
